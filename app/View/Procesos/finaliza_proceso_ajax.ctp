...
<div class="panel-heading">
    <span class="panel-title">
        <i class="fa fa-stop"></i>Finalizacion</span>
</div>
...
<div class="panel-body p25">
    <!--<div class="alert alert-info pastel alert-dismissable">
        ...
        <strong>Informacion!</strong> Se cambiara o se creara un estado de Finalizado en el proceso que podria influir en dias de vencimiento y activacion o finalizacion automatica.
    </div>-->
    <div class="section">
        <label for="datepicker1" class="field prepend-icon">
            <?php echo $this->Form->text('ProcesosEstado.created', array('class' => 'form-control ddatepicker2', 'placeholder' => 'Fecha de Activacion', 'id' => 'ddatepicker1','required')); ?>
...
<?php echo $this->Form->hidden('ProcesosEstado.estado', array('value' => 'Finalizado')); ?>
...
<script>
    $('#f-add').submit(function (e) {
        ...
        $.ajax({
            url: '<?= $this->Html->url(array('controller' => 'Procesos', 'action' => 'finaliza_proceso_ajax', $idFlujosUser, $idProceso));?>',
            type: 'POST',
            data: postData,
